...
HD_PWD='C:/Users/KIIT/Desktop/mat_mul/vivado/MatrixMultiplier_project/MatrixMultiplier_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MatrixMultiplier_Wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MatrixMultiplier_Wrapper.tcl
